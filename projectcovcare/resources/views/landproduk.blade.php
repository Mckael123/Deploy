        ...
        <section class="isi">
            ...
            <div class="isi-bawah">
                ...
                <div class="isi-category">
                    <a href="{{url('/KitPencegahan')}}" style="text-decoration: none;margin :auto;">
                    ...
                    <a href="{{url('/KitPositif')}}" style="text-decoration: none;margin :auto;">
                        <div class="box-content">
                    ...
                    <a href="{{url('/KitPascapositif')}}" style="text-decoration: none; margin :auto;">
                        <div class="box-content">
